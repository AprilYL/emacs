...
(yas-define-snippets 'python-mode
		     '(("ud" "##############################################################################\n# UPDATE ${1:$$(upcase yas-text)} TABLE\n##############################################################################\nUPDATE_${1:$(upcase yas-text)}_TABLE = \\\"\\\"\\\"\nUPDATE\n    ${2:$$(upcase yas-text)}\nSET\n    ${3:$$(upcase yas-text)}\nWHERE\n    ${4:$$(upcase yas-text)}\n\\\"\\\"\\\"\n$0" "python update sql" nil nil nil "/Users/april/.emacs.d/snippets/python-mode/update" nil nil)
		       ...
		       ("pyw" "# -*- coding: utf-8 -*-\n# !/usr/bin/env python3.6\n# File: `(file-name-nondirectory buffer-file-name)`\n# Create by Lin Yang at `(insert (shell-command-to-string \"echo -n $(date +%Y-%m-%d)\"))`\n# Email: YangLin@163.com\n$0\n" "insert work python header" nil nil nil "/Users/april/.emacs.d/snippets/python-mode/python_header_work" nil nil)
		       ...
		       ("autoreload" "%load_ext autoreload\n%autoreload 2\n\n" "jupyter autoreload" nil nil nil "/Users/april/.emacs.d/snippets/python-mode/autoreload" nil nil)))
