...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ein-notebook" '(#("ein:" 0 4 (fontified nil face font-lock-function-name-face)) #("*ein:notebook--pending-query*" 0 29 (face font-lock-variable-name-face)))))
